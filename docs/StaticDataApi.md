...
public class Example {
  public static void main(String[] args) {
    ...
    String countryCode = "SG"; // String | Country code in iso-2 format (example: SG)
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    StaticDataApi apiInstance = new StaticDataApi(defaultClient);
    Integer hotelId = 57871; // Integer | Unique ID of a hotel
    try {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **hotelId** | **Integer**| Unique ID of a hotel | |
...
public class Example {
  public static void main(String[] args) {
    ...
    StaticDataApi apiInstance = new StaticDataApi(defaultClient);
    String countryCode = "SG"; // String | country code ISO-2 code - example (SG)
    String cityName = "Singapore"; // String | name of the city
    Integer offset = 0; // Integer | specifies the number of rows to skip before starting to return rows
    Integer limit = 1000; // Integer | limit number of results (max 1000)
    BigDecimal longitude = new BigDecimal("-115.16988"); // BigDecimal | longitude geo coordinates
    BigDecimal latitude = new BigDecimal("36.12510"); // BigDecimal | latitude geo coordinates
    Integer distance = 1000; // Integer | distance in meters (min 1000m)
    try {
...
| **longitude** | **BigDecimal**| longitude geo coordinates | [optional] |
