...
public class Example {
  public static void main(String[] args) {
    ...
    String bookingId = " hSq2gVDrf"; // String | The Booking Id that needs to be retrieved
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    BookingManagementApi apiInstance = new BookingManagementApi(defaultClient);
    String bookingId = "hSq2gVDrf"; // String | (Required) The unique identifier of the booking you would like to update.
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    BookingManagementApi apiInstance = new BookingManagementApi(defaultClient);
    String guestId = "FrT56hfty"; // String | The Guest Id of the user
    try {
