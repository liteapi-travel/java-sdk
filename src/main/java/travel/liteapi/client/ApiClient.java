...
import travel.liteapi.client.auth.Authentication;
import travel.liteapi.client.auth.HttpBasicAuth;
import travel.liteapi.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("liteAPI-Generator/2.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.liteapi.travel/v2.0
     ...
     * @return a {@link travel.liteapi.client.ApiClient} object
     */
     ...
     * @throws travel.liteapi.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws travel.liteapi.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws travel.liteapi.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws travel.liteapi.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws travel.liteapi.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws travel.liteapi.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws travel.liteapi.client.ApiException If fails to update the parameters
     */
     ...
     * @throws travel.liteapi.client.ApiException If fail to serialize the request body object into a string
     */
