...
public abstract class AbstractLiteApiSchema {
    ...
    public AbstractLiteApiSchema(String schemaType, Boolean isNullable) {
    ...
    private Object getActualInstanceRecursively(AbstractLiteApiSchema object) {
        if (object.getActualInstance() == null) {
            return null;
        } else if (object.getActualInstance() instanceof AbstractLiteApiSchema) {
            return getActualInstanceRecursively((AbstractLiteApiSchema)object.getActualInstance());
        } else {
    ...
    public boolean equals(Object o) {
        ...
        AbstractLiteApiSchema a = (AbstractLiteApiSchema) o;
