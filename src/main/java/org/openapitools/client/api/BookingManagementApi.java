...
public class BookingManagementApi {
     ...
     */
    public okhttp3.Call bookingsBookingIdGetCall(Object bookingId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call bookingsBookingIdGetValidateBeforeCall(Object bookingId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object bookingsBookingIdGet(Object bookingId) throws ApiException {
     ...
     */
    public ApiResponse<Object> bookingsBookingIdGetWithHttpInfo(Object bookingId) throws ApiException {
     ...
     */
    public okhttp3.Call bookingsBookingIdGetAsync(Object bookingId, final ApiCallback<Object> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> OK </td><td>  * Date -  <br>  * Content-Type -  <br>  * Content-Length -  <br>  * Connection -  <br>  * x-amzn-RequestId -  <br>  * Access-Control-Allow-Origin -  <br>  * Content-Encoding -  <br>  * Access-Control-Allow-Headers -  <br>  * x-amzn-Remapped-Content-Length -  <br>  * x-amz-apigw-id -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Expose-Headers -  <br>  * x-amzn-Remapped-Date -  <br>  * Access-Control-Max-Age -  <br>  * Access-Control-Allow-Credentials -  <br>  </td></tr>
        <tr><td> 204 </td><td> No Content </td><td>  * Access-Control-Allow-Credentials -  <br>  * Access-Control-Allow-Headers -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Allow-Origin -  <br>  * Access-Control-Expose-Headers -  <br>  * Access-Control-Max-Age -  <br>  * Content-Type -  <br>  * Date -  <br>  * Content-Length -  <br>  </td></tr>
        <tr><td> 304 </td><td> Not Modified </td><td>  * Access-Control-Allow-Credentials -  <br>  * Access-Control-Allow-Headers -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Allow-Origin -  <br>  * Access-Control-Expose-Headers -  <br>  * Access-Control-Max-Age -  <br>  * Content-Type -  <br>  * Date -  <br>  * Content-Length -  <br>  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  * Access-Control-Allow-Credentials -  <br>  * Access-Control-Allow-Headers -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Allow-Origin -  <br>  * Access-Control-Expose-Headers -  <br>  * Access-Control-Max-Age -  <br>  * Content-Type -  <br>  * Date -  <br>  * Content-Length -  <br>  </td></tr>
     </table>
     */
    public okhttp3.Call bookingsBookingIdPutCall(Object bookingId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingsBookingIdPutValidateBeforeCall(Object bookingId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'bookingId' is set
        if (bookingId == null) {
            throw new ApiException("Missing the required parameter 'bookingId' when calling bookingsBookingIdPut(Async)");
        }

        return bookingsBookingIdPutCall(bookingId, _callback);
     ...
     */
    public Object bookingsBookingIdPut(Object bookingId) throws ApiException {
        ApiResponse<Object> localVarResp = bookingsBookingIdPutWithHttpInfo(bookingId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> bookingsBookingIdPutWithHttpInfo(Object bookingId) throws ApiException {
        okhttp3.Call localVarCall = bookingsBookingIdPutValidateBeforeCall(bookingId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call bookingsBookingIdPutAsync(Object bookingId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingsBookingIdPutValidateBeforeCall(bookingId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call bookingsGetCall(Object guestId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call bookingsGetValidateBeforeCall(Object guestId, final ApiCallback _callback) throws ApiException {
        ...
        return bookingsGetCall(guestId, _callback);
     ...
     */
    public Object bookingsGet(Object guestId) throws ApiException {
        ApiResponse<Object> localVarResp = bookingsGetWithHttpInfo(guestId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> bookingsGetWithHttpInfo(Object guestId) throws ApiException {
        okhttp3.Call localVarCall = bookingsGetValidateBeforeCall(guestId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call bookingsGetAsync(Object guestId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = bookingsGetValidateBeforeCall(guestId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
