...
public class SearchApi {
     ...
     * @param guestNationality Guest nationality ISO-2 code - example (SG) (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 204 </td><td> No Content </td><td>  * Access-Control-Allow-Credentials -  <br>  * Access-Control-Allow-Headers -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Allow-Origin -  <br>  * Access-Control-Expose-Headers -  <br>  * Access-Control-Max-Age -  <br>  * Content-Type -  <br>  * Date -  <br>  * Content-Length -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call hotelsGetCall(String hotelIds, String checkin, String checkout, String currency, String guestNationality, Integer adults, String children, String guestId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call hotelsGetValidateBeforeCall(String hotelIds, String checkin, String checkout, String currency, String guestNationality, Integer adults, String children, String guestId, final ApiCallback _callback) throws ApiException {
        ...
        return hotelsGetCall(hotelIds, checkin, checkout, currency, guestNationality, adults, children, guestId, _callback);
     ...
     */
    public Object hotelsGet(String hotelIds, String checkin, String checkout, String currency, String guestNationality, Integer adults, String children, String guestId) throws ApiException {
        ApiResponse<Object> localVarResp = hotelsGetWithHttpInfo(hotelIds, checkin, checkout, currency, guestNationality, adults, children, guestId);
     ...
     */
    public ApiResponse<Object> hotelsGetWithHttpInfo(String hotelIds, String checkin, String checkout, String currency, String guestNationality, Integer adults, String children, String guestId) throws ApiException {
        okhttp3.Call localVarCall = hotelsGetValidateBeforeCall(hotelIds, checkin, checkout, currency, guestNationality, adults, children, guestId, null);
     ...
     */
    public okhttp3.Call hotelsGetAsync(String hotelIds, String checkin, String checkout, String currency, String guestNationality, Integer adults, String children, String guestId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = hotelsGetValidateBeforeCall(hotelIds, checkin, checkout, currency, guestNationality, adults, children, guestId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 204 </td><td> No Content </td><td>  * Date -  <br>  * Content-Type -  <br>  * Content-Length -  <br>  * Connection -  <br>  * x-amzn-RequestId -  <br>  * Access-Control-Allow-Origin -  <br>  * Content-Encoding -  <br>  * Access-Control-Allow-Headers -  <br>  * x-amz-apigw-id -  <br>  * Access-Control-Allow-Methods -  <br>  * Access-Control-Expose-Headers -  <br>  * x-amzn-Remapped-Date -  <br>  * Access-Control-Max-Age -  <br>  * Access-Control-Allow-Credentials -  <br>  </td></tr>
     ...
     */
    public okhttp3.Call hotelsRatesGetCall(String hotelIds, String checkin, String checkout, String guestNationality, String currency, Integer adults, String children, String guestId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call hotelsRatesGetValidateBeforeCall(String hotelIds, String checkin, String checkout, String guestNationality, String currency, Integer adults, String children, String guestId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'hotelIds' is set
        if (hotelIds == null) {
        ...
        return hotelsRatesGetCall(hotelIds, checkin, checkout, guestNationality, currency, adults, children, guestId, _callback);
     ...
     */
    public Object hotelsRatesGet(String hotelIds, String checkin, String checkout, String guestNationality, String currency, Integer adults, String children, String guestId) throws ApiException {
        ApiResponse<Object> localVarResp = hotelsRatesGetWithHttpInfo(hotelIds, checkin, checkout, guestNationality, currency, adults, children, guestId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> hotelsRatesGetWithHttpInfo(String hotelIds, String checkin, String checkout, String guestNationality, String currency, Integer adults, String children, String guestId) throws ApiException {
        okhttp3.Call localVarCall = hotelsRatesGetValidateBeforeCall(hotelIds, checkin, checkout, guestNationality, currency, adults, children, guestId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call hotelsRatesGetAsync(String hotelIds, String checkin, String checkout, String guestNationality, String currency, Integer adults, String children, String guestId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = hotelsRatesGetValidateBeforeCall(hotelIds, checkin, checkout, guestNationality, currency, adults, children, guestId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
